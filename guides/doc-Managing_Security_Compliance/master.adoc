...
include::common/modules/proc_deploying-a-policy-in-a-host-group-by-using-ansible.adoc[leveloffset=+2]

include::common/modules/proc_deploying-a-policy-on-a-host-by-using-ansible.adoc[leveloffset=+2]

include::common/modules/proc_deploying-a-policy-in-a-host-group-by-using-puppet.adoc[leveloffset=+2]

include::common/modules/proc_deploying-a-policy-on-a-host-by-using-puppet.adoc[leveloffset=+2]
