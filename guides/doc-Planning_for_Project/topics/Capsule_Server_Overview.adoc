...
ifndef::satellite[]
If you have the Katello plugin installed, you can also configure {SmartProxy} to mirror content from {ProjectServer}.
endif::[]
...
* *Baseboard Management Controller (BMC)* – {SmartProxy} can provide power management for hosts by using IPMI or Redfish.
...
ifndef::satellite[]
Content related features, provided by the Katello plugin:
endif::[]
...
* {InstallingServerDocURL}Port_and_firewall_requirements_{project-context}[Port and firewall requirements] in _{InstallingServerDocTitle}_
ifdef::satellite[]
* {InstallingServerDisconnectedDocURL}Port_and_firewall_requirements_{project-context}[Port and firewall requirements] in _{InstallingServerDisconnectedDocTitle}_
endif::[]
* {InstallingSmartProxyDocURL}{smart-proxy-context}-port-and-firewall-requirements_{smart-proxy-context}[Port and firewall requirements] in _{InstallingSmartProxyDocTitle}_
