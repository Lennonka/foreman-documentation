...
include::common/modules/proc_authenticating-salt-minions-by-using-salt-autosign-grains.adoc[leveloffset=+2]

include::common/modules/proc_authenticating-salt-minions-by-using-host-names.adoc[leveloffset=+2]
