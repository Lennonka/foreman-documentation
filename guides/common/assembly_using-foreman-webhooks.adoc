...
include::modules/proc_passing-arguments-to-shellhook-script-by-using-webhooks.adoc[leveloffset=+1]

include::modules/proc_passing-arguments-to-shellhook-script-by-using-curl.adoc[leveloffset=+1]
