...
// Global registration
include::modules/con_registering-hosts-by-by-using-global-registration.adoc[leveloffset=+1]
...
include::modules/proc_customizing-host-registration-by-by-using-snippets.adoc[leveloffset=+2]

include::modules/proc_customizing-the-registration-templates.adoc[leveloffset=+2]

ifdef::satellite,orcharhino[]
// Bootstrap script
include::modules/proc_registering-hosts-by-by-using-the-bootstrap-script.adoc[leveloffset=+1]
