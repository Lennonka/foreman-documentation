...
The following table describes the scalability limits when using the recommended 4 CPUs.

.Puppet scalability with 4 CPUs
[cols=",",options="header"]
|====
...
The following table describes the scalability limits when using the minimum 2 CPUs.

.Puppet scalability with 2 CPUs
[cols=",",options="header"]
|====
|Puppet Managed Resources per Host| Run-Interval Distribution
|  1 | 1700{range}1450
