[id="Propagating_SCAP_Content_by_using_Puppet_Deployment_{context}"]
= Propagating SCAP content by using Puppet deployment
...
. Continue with deploying a compliance policy by using Puppet.
For more information, see:
* {ManagingSecurityDocURL}Deploying_a_Policy_in_a_Host_Group_by_Using_Puppet_security-compliance[Deploying a Policy in a Host Group Using Puppet] in _{ManagingSecurityDocTitle}_
* {ManagingSecurityDocURL}Deploying_a_Policy_on_a_Host_by_Using_Puppet_security-compliance[Deploying a Policy on a Host Using Puppet] in _{ManagingSecurityDocTitle}_
