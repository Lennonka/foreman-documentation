...
** When patching content hosts, change the lifecycle environment from `2023-Q4` to `2024-Q1` by using the {ProjectWebUI}, {Project} API, Hammer CLI, or an activation key.
