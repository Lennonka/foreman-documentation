...
.CLI procedure
* Promote the content view by using Hammer for each lifecycle environment:
+
...
* Alternatively, you can promote content views across all lifecycle environments within an organization by using the following Bash script:
+
