...
When remote execution (REX) on {ProjectServer} is configured for pull-based transport, {SmartProxyServer} sends notifications about new jobs to clients through MQTT.
