[id="Applying_Errata_to_Hosts_Running_{os_name_anchor}_{os_major_anchor}_{context}"]
= Applying errata to hosts running {os_name} {os_major}

include::snip_applying-errata.adoc[]

[id="cli-Applying_Errata_to_Hosts_Running_{os_name_anchor}_{os_major_anchor}_{context}"]
.CLI procedure
...
Identify the erratum to apply by using the erratum ID:
+
