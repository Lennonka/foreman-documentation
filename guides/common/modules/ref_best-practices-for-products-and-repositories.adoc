...
File repositories require a `PULP_MANIFEST` file that you can create by using `pulp-manifest /path/to/files`.
...
If you set *Protected* to true, you can only download content by using a global debugging certificate.
