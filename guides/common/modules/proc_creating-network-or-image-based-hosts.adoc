...
* If you want to create a host with an existing image, the new host entry triggers the {CRname} server to create the virtual machine by using a pre-existing image as a basis for the new volume.
