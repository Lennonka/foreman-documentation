...
The kickstart provisioning templates in {ProjectName} contain commands to register the host by using an activation key that is defined when creating a host.
