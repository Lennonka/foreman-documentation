include::modules/con_configuring-keycloak-wildfly-authentication-with-piv-cards-for-project.adoc[]
...
include::modules/proc_configuring-project-settings-for-keycloak-wildfly-authentication-by-using-the-web-ui.adoc[leveloffset=+1]

include::modules/proc_configuring-project-settings-for-keycloak-wildfly-authentication-by-using-the-cli.adoc[leveloffset=+1]
